...
# 💡 슈피겐코리아 예외 처리 (공백 제거, K->k 소문자 적용)
    ...
    '홍개세종탬시설': '홍대세종캠퍼스시설',
    '교원안성사업장': '안성교원물류',
    '한국에너지기술연구언': '한국에너지기술연구원',
    '경산쿠팡1,2센FC': '쿠팡경산1,2센터',
    '부천메리츠화재': '메리츠화재부천',
    '당퍼스타워,백상코퍼레이션': '퍼스트타워',
    '아이컴바인드(백상)': '아이아이컴바인드',
    'CK106': '을지로타워',
    ...
    '국미은행일산연수원': '국민은행일산연수원',
    'ck06': '을지로타워',
    'LG에너지지솔루션과천R&D캠퍼스': '에너지솔루션과천',
    '쿠팣대구3센터': '쿠팡대구3센터',
    '대전통합청사이준수소장': '나라키움대전통합청사',
    '매리츠부천사옥': '메리츠화재부천',
    '인천쿠팡5센터': '쿠팡인천5센터',
    'ck106운영센타': '을지로타워',
    'KGC인삼공사원주공장': 'KGC원주공장',
    ...
    '남대문자유시장': '남대문자유상가',
    '안성물류센터': '안성교원물류',
    '동탄lh스마트주차잘': '동탄lh스마트주차장',
    '슈피겐코리아k231': '슈피겐인천물류센터',
    '인천쿠팡16센터': '쿠팡인천16센터',
    '쿠팡양지4FC': '쿠팡양지4,7센터',
    '쿠파미천2센터': '쿠팡이천2센터',
    '국민은핼일산연수원': '국민은행일산연수원',
    ...
    '백상엘리츠1치': '백상앨리츠1차',
    '메리츠화자연수원': '메리츠화재연수원',
    '깁도물산mh빌딩소장주정윤': '갑도물산MH빌딩',
    '서울예대가숙사윤석병': '서울예대기숙사',
    'GS': 'GS타워',
    '양지33신타': '쿠팡양지3센터',
    '쿠팡5센터': '쿠팡인천5센터',
    '산학재단': '산학협동재단',
    '슈피겐코리아인천물류': '슈피겐인천물류센터',
    '343강님빌딩': '343강남빌딩',
    '전주사업장': '전주현대자동차',
    '쿠팡이천4센타': '쿠팡이천4센터',
    '현대자동현대차금정지점': '현대차금정지점',
    '동탄lh스마트주치장': '동탄lh스마트주차장',
    '앙지3센타': '쿠팡양지3센터',
    '서울예술대캠퍼스': '서울예대캠퍼스',
    'KB국민은행대천연수육ㄴ': '국민은행대천연수원',
