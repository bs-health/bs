...
CUSTOM_TYPO_MAPPING = {
    ...
    '교원대구빌딩': '대구교원',
    '쿠팡 평택5센타': '쿠팡평택5센터',
    '슈피겐코리아k231 인천물류센터': '슈피겐 인천물류센터',
    '슈피겐코리아k231': '슈피겐 인천물류센터',
    '슈피겐k231인천물류센터': '슈피겐 인천물류센터',
    '슈피겐코리아k231인천물류센터': '슈피겐 인천물류센터',
    '한남동 청암빌딩': '청암빌딩',
    '국립소방병원': '소방병원',
    ...
    '쿠팡인천5센타': '쿠팡인천5센터',
    '쿠팡 평택5센타': '쿠팡평택5센터',
    'KB국민은행연수원 대천연수원': '국민은행대천연수원',
    '천경 을지로 운영센터': '을지로타워',
    '파크원 LG에너지솔루션': '파크원에너지솔루션',
    '국민건강보험공단 별관': '건강보험공단별관',
    '경주교원드림센터 임현석': '교원경주드림센터',
    '교원일산빌딩': '일산후곡빌딩',
    '전주자동차': '전주현대자동차',
    '교원 파주물류센타': '파주교원물류센터',
    '현대자동차금정지점': '현대차금정지점',
